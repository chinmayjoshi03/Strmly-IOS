...
interface ThumbnailSelectScreenProps {
...
const ThumbnailSelectScreen: React.FC<ThumbnailSelectScreenProps> = ({
  onThumbnailSelected,
  onBack,
  onContinue,
  selectedVideo,
  ...
  const handleSelectFromGallery = async () => {
    try {
      ...
      const result = await ImagePicker.launchImageLibraryAsync({
        ...
        allowsEditing: true,
        aspect: [16, 9], // Recommended aspect ratio for video thumbnails
        quality: 0.8,
      });

      if (!result.canceled && result.assets && result.assets.length > 0) {
        const thumbnail = result.assets[0];
        console.log("✅ ThumbnailSelectScreen: Selected thumbnail:", {
          uri: thumbnail.uri,
  ...
  const handleTakePhoto = async () => {
    try {
      ...
      if (!result.canceled && result.assets && result.assets.length > 0) {
        const thumbnail = result.assets[0];
        console.log("✅ ThumbnailSelectScreen: Captured thumbnail:", {
          uri: thumbnail.uri,
          width: thumbnail.width,
          height: thumbnail.height,
        });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Add Thumbnail</Text>
        ...
        <View style={styles.innerContainer}>
          ...
          <View style={styles.infoSection}>
            ...
            <Text style={styles.infoDescription}>
              Choose an eye-catching image that represents your video. A good thumbnail can help attract more viewers.
            </Text>
          </View>
      ...
      <View style={styles.actionButtonsContainer}>
        ...
        >
          <Text style={styles.continueButtonText}>
            {selectedThumbnail ? "Continue with Thumbnail" : "Continue without Thumbnail"}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
...
export default ThumbnailSelectScreen;